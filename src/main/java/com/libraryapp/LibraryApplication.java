...
public class LibraryApplication {
	...
	CommandLineRunner runner() {
		return args -> {
			...
			User user1 = new User("admin1", pwEncoder.encode("test"), "zineb.reede@gmail.com", "Zineb", "Bayzi", "Huizumerlaan 158", "06-11433823", "Amsterdam");
			user1.setRole("ROLE_ADMIN");

			User user50 = new User("admin2", pwEncoder.encode("test"), "zineb.reede@gmail.com", "hind", "El ouazzani", "Huizumerlaan 158", "06-11433823", "Amsterdam");
			user1.setRole("ROLE_ADMIN");
			
			User user2 = new User("employee", pwEncoder.encode("test"), "cyrille.jones@gamail.com", "Employe1", "Ld", "Hugo de Grootstraat 174", "06-87054875", "Sliedrecht");
			user2.setRole("ROLE_EMPLOYEE");
			
			User user3 = new User("user", pwEncoder.encode("test"), "kevin.leijnse@gmail.com", "User ", "X", "Leidijk 97", "06-18756892", "Groningen");
